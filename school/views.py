...
def index_page(request):
    ...
    banner_list      = models.SliderInfo.objects.filter(slider_for = 1).order_by('slider_order').reverse()[:6]
    corner_list      = models.SliderInfo.objects.filter(slider_for = 2).order_by('slider_order').reverse()[:6]
...
def institute_message(request):
    ...
    return render(request, 'school/institute_message.html', context)   
...
def contact_us(request):
    if request.method == 'POST':
        ...
        models.Contact.objects.create(name = name, email = email,subject = subject, phone = phone, message = message)
...
def result_history(request):
    ...
    return render(request, 'school/result_history.html')   
...
def our_history(request):
    ...
    return render(request, 'school/our_history.html', context)   

def chairman_message(request):
    chairman     = models.AcademicMessage.objects.filter(message_for = 2).last()
    context = {
        'chairman':chairman,
    }
    return render(request, 'school/chairman_message.html', context)   

def principal_message(request):
    principal         = models.AcademicMessage.objects.filter(message_for = 3).last()
    
    context = {
        'principal':principal,
        
    }
    return render(request, 'school/principal_message.html', context)   
...
def at_a_glance(request):
    ...
    return render(request, 'school/at_a_glance.html', context)   
...
def teacher_info(request):
    ...
    return render(request, 'school/teacher_info.html', context)   

def committee_info(request):
    school_info      = models.SchoolProfile.objects.all().last()
    committee_list   = models.AcademicTeam.objects.filter(academic_member = 1)
    ...
    return render(request, 'school/committee_info.html', context)   
...
def why_study_here(request):
    ...
    return render(request, 'school/why_study_here.html', context) 
...
def admission_form(request):
    ...
    return render(request, 'school/admission_form.html') 

def exam_regulations(request):
    
    return render(request, 'school/exam_regulations.html') 

def admission_suspension(request):
    
    return render(request, 'school/admission_suspension.html') 
...
def admission_information(request):
    ...
    return render(request, 'school/admission_information.html', context) 
...
def institute_facility(request):
    ...
    return render(request, 'school/institute_facility.html', context)   
...
def photo_gallery(request):
    ...
    return render(request, 'school/photo_gallery.html', context)   
...
def video_gallery(request):
    ...
    return render(request, 'school/video_gallery.html', context)   
...
def all_notices(request):
    ...
    return render(request, 'school/all_notices.html', context)   
...
def view_notices(request,id):
    ...
    return render(request, 'school/view_notice.html', context)   
...
def job_vacancy(request):
    ...
    return render(request, 'school/job_vacancy.html', context)   
...
def all_events(request):
    ...
    return render(request, 'school/all_events.html', context)   
...
def view_events(request,id):
    ...
    return render(request, 'school/view_events.html', context)   

def eiin_number(request):
    context = {
        'school_info':models.SchoolProfile.objects.all().last(),
    }
    return render(request, 'school/eiin_number.html', context)  
...
def library_page(request):
    ...
    return render(request, 'school/library_page.html', context)   
...
def hostel_page(request):
    ...
    return render(request, 'school/hostel_page.html', context)   
...
def lab_page(request):
    ...
    return render(request, 'school/lab_page.html', context)   
...
def idcard_page(request):
    ...
    return render(request, 'school/idcard_page.html', context)   
...
def quran_class(request):
    ...
    return render(request, 'school/quran_class.html', context)   
...
def bncc_page(request):
    ...
    return render(request, 'school/bncc_page.html', context)   
...
def test_api(request):
    job_list = models.JobCircular.objects.all()
...
def student_dashboard(request):
    ...
    return render(request, 'school/admin/student_dashboard.html')   
...
def student_reg(request):
    ...
    return render(request, 'school/admin/reg_student.html', context)   
...
def student_list(request):
    ...
    return render(request, 'school/admin/student_list.html',{'student_list':student_list})   
...
def student_photos_list(request):
    ...
    return render(request, 'school/admin/student_photos_list.html',{'student_photos_list':student_photos_list})   
...
def parents_list(request):
    ...
    return render(request, 'school/admin/parents_list.html',{'parents_list':parents_list})   
...
def parents_photos_list(request):
    ...
    return render(request, 'school/admin/parents_photos_list.html',{'parents_photos_list':parents_photos_list})   
...
def guardian_list(request):
    ...
    return render(request, 'school/admin/guardian_list.html',{'guardian_list':guardian_list})   
...
def guardian_photos_list(request):
    ...
    return render(request, 'school/admin/guardian_photos_list.html',{'guardian_photos_list':guardian_photos_list})   
...
def scholarship_student_list(request):
    ...
    return render(request, 'school/admin/scholarship_student_list.html',{'scholarship_student_list': scholarship_student_list})   
...
def inactive_student_list(request):
    ...
    return render(request, 'school/admin/inactive_student.html',{'inactive_student_list': inactive_student_list})   
...
def quick_admission_list(request):
    ...
    return render(request, 'school/admin/quick_admission_list.html',{'quick_admission_list': quick_admission_list})   
...
def quick_admission(request):
    ...
    return render(request, 'school/admin/quick_admission.html')   
...
def mark_distribution(request):
    ...
    return render(request, 'school/admin/mark_distribution.html', context )   
...
def mark_distribution_list(request):
    ...
    return render(request, 'school/admin/mark_distribution_list.html', context )   
...
def employee_reg(request):
    ...
    return render(request, 'school/admin/reg_employee.html', context)   
...
def employee_list(request):
    ...
    return render(request, 'school/admin/employee_list.html', {'employee_list':employee_list })   
...
def teacher_list(request):
    ...
    return render(request, 'school/admin/teacher_list.html', {'teacher_list':teacher_list })   
...
def apiTest(request):
    ...
    return render(request, 'school/api.html', {'api':api}) 
